...
export declare function assembleAndInitializeFrontend({ appId, popups, authMediator, remote, }: {
    appId: string;
    popups: SystemPopups;
    ...
    components: {
        ...
        } & typeof import("../../features/administrative/components/xiome-manage-users.js").XiomeManageUsers;
        XiomeQuestions: {
            new (...args: any[]): {
                "__#3@#unsubscribes": (() => void)[];
                connectedCallback(): void;
        ...
        } & typeof import("../../features/questions/components/xiome-questions.js").XiomeQuestions;
        XiomeMyAvatar: {
            new (...args: any[]): {
        ...
        } & typeof import("../../features/auth/components/my-avatar/xiome-my-avatar.js").XiomeMyAvatar;
        XiomeLoginPanel: {
            new (...args: any[]): {
                firstUpdated(changes: Map<string | number | symbol, unknown>): void;
                auto: {
        ...
        } & typeof import("../../features/auth/components/login-panel/xiome-login-panel.js").XiomeLoginPanel;
        XiomeAppManager: {
            new (...args: any[]): {
                "__#3@#unsubscribes": (() => void)[];
                connectedCallback(): void;
        ...
        } & typeof import("../../features/auth/components/apps/xiome-app-manager.js").XiomeAppManager;
        XiomeMyAccount: {
            new (...args: any[]): {
                firstUpdated(changes: Map<string | number | symbol, unknown>): void;
                auto: {
        ...
        } & typeof import("../../features/auth/components/my-account/xiome-my-account.js").XiomeMyAccount;
        XiomePermissions: {
            new (...args: any[]): {
                "__#3@#unsubscribes": (() => void)[];
                connectedCallback(): void;
        ...
        } & typeof import("../../features/auth/components/permissions/xiome-permissions.js").XiomePermissions;

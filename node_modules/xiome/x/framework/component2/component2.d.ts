...
export declare class Component2 extends Component2_base {
    init(): void;
    firstUpdated(changes: PropertyValues): void;
}
export declare class Component2WithShare<xShare> extends Component2 {
    readonly share: xShare;
    constructor();
}
declare const Component3_base: {
    new (...args: any[]): {
        connectedCallback(): void;
        observedAttributes?: string[];
        disconnectedCallback?(): void;
...
export declare class Component3 extends Component3_base {
    init(): void;
    firstUpdated(changes: PropertyValues): void;
}
export declare class Component3WithShare<xShare> extends Component3 {
    readonly share: xShare;
    constructor();
}

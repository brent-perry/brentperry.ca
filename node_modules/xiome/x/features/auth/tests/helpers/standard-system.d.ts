...
export declare function standardSystem(): Promise<{
    backend: {
        api: {
            auth: {
        ...
        emails: {
            sendEmail: import("../../types/emails/send-email.js").SendEmail;
            enableEmails: () => void;
            disableEmails: () => void;
            sendLoginEmail: (details: import("../../types/emails/login-email-details.js").LoginEmailDetails) => Promise<void>;
            recallLatestLoginEmail: () => import("../../types/emails/login-email-details.js").LoginEmailDetails;
        };
        database: import("../../../../assembly/backend/types/database.js").Database;
        stripeComplex: {
        ...
        mockBrowser: () => Promise<{
            mockAppWindow: ({ appId, apiLink, latency, windowLink, }: {
                ...
                apiLink: string;
                windowLink: string;
                latency: import("../../../../framework/add-mock-latency.js").MockLatency;
            }) => Promise<{
                models: {
                    appModel: {
                        readonly state: {
    ...
    platformAppId: string;
    signupAndLogin: ({ email, appLink, appId }: {
        appId: string;
        email: string;
        appLink: string;
    }) => Promise<{

...
export async function creativeSignupAndLogin(email) {
    ...
    assert(await windowForLogin.models.authModel.getValidAccess(), "creative is logged in");
    return windowForLogin;
}
//# sourceMappingURL=creative-signup-and-login.js.map
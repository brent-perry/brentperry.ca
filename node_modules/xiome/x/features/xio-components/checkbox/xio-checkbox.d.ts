...
import { Component2 } from "../../../framework/component2/component2.js";
export declare class XioCheckbox extends Component2 {
    private loading;
    ...
    toggle(previousChecked?: boolean, dispatchEvent?: boolean): Promise<boolean>;
    private handleClick;

...
export declare type ToApiContext<xMeta, xAuth, xTopic extends Topic<xAuth>, xPolicy extends Policy<xMeta, xAuth, any>> = {
    [P in keyof xTopic]: xTopic[P] extends Procedure<xAuth, any[], any> ? ProcedureDescriptor<xMeta, xAuth, DropFirst<Parameters<xTopic[P]>>, Await<ReturnType<xTopic[P]>>, xPolicy> : xTopic[P] extends Topic<xAuth> ? ToApiContext<xMeta, xAuth, xTopic[P], xPolicy> : never;
} & {

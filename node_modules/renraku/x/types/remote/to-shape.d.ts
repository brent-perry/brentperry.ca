...
export declare type ToShape<xApi extends Api> = {
    [P in keyof xApi]: xApi[P] extends ProcedureDescriptor<any, any, any[], any, any> ? true : xApi[P] extends Api ? xApi[P] extends ToApiContext<any, any, any, any> ? {
        [_augment]: Augment<xApi[P][typeof _context]["meta"]>;
    } & {
        [P2 in keyof OnlyProcedureDescriptors<xApi[P]>]: true;
    } : ToShape<xApi[P]> : never;
};
